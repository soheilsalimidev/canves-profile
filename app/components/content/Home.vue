<template>
  <section class="relative pt-12">
    ...
    <div class="relative mx-auto flex max-w-7xl flex-col justify-center gap-4 px-4 py-8 sm:px-6 lg:px-8 lg:py-16">
      <!-- spotlight -->
      <div
        class="absolute -top-8 left-1/2 size-72 -translate-x-1/2 rounded-full bg-purple-400/25 blur-[120px] lg:-top-8 lg:size-[32rem] lg:blur-[200px]"
      />
      ...
      <div class="z-20 flex flex-col items-center justify-center">
        ...
        <div
          ...
          data-animate
        >
          <h1 class="mx-auto font-medium text-center text-pretty bg-gradient-to-b from-[#d397fa] to-[#8364e8] bg-clip-text text-3xl text-transparent lg:max-w-3xl lg:text-4xl">
            <slot
              name="hero_title"
              mdc-unwrap="p"
            />
