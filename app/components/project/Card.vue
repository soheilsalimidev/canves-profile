...
<template>
  ...
  >
    ...
    <div class="flex h-56 justify-center overflow-hidden rounded-lg text-center">
      <NuxtImg
        v-if="project.image"
      ...
      />
      <div v-else class="w-full h-full flex justify-center items-center">An AI project, so there can not be pic of mode :(</div>
    </div>
